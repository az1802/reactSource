...
// reactElements 到  DOM节点中。  利用updateContainerj进行更新
...
function createRootImpl(
  ...
  markContainerAsRoot(root.current, container); //建立DOM container与fiber root节点的关系
