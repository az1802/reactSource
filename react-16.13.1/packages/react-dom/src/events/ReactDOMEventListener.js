...
// Attempt dispatching an event. Returns a SuspenseInstance or Container if it's blocked. 尝试事件的调度
export function attemptToDispatchEvent(
  ...
  let targetInst = getClosestInstanceFromNode(nativeEventTarget);//获取最近的fiber节点

  if (targetInst !== null) {
    let nearestMounted = getNearestMountedFiber(targetInst); //找到最近的根节点
