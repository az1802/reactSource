...
/**
 * 验证fragment props上只能有chilren和key不可以存在其他属性
...
export function createElementWithValidation(type, props, children) {
  ...
  if (!validType) {
    ...
    // 开发环境中props.__source信息中包含columnNumber: 3fileName: "./my-app/src/index.js",lineNumber: 17  在jsx转换的时候会被解析进去
